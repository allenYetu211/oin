...
>;
export type PostApiMembershipResult = NonNullable<
  Awaited<ReturnType<typeof postApiMembership>>
>;
export type GetApiMembershipResult = NonNullable<
  Awaited<ReturnType<typeof getApiMembership>>
>;
