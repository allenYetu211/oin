...
export const postApiMembership = (
 ...
 options?: SecondParameter<typeof customInstance>,) => {
      ...
      {url: `/api/membership`, method: 'post',
      headers: {'Content-Type': 'application/json', },
 ...
 * @summary 查找全部登记会员
 */
export const getApiMembership = (
    
 options?: SecondParameter<typeof customInstance>,) => {
      return customInstance<GetApiMembership200>(
...
export const putApiUsersUpdateMembershipLevel23 = (
 ...
 options?: SecondParameter<typeof customInstance>,) => {
      ...
      {url: `/api/users/updateMembershipLevel/23`, method: 'put',
      headers: {'Content-Type': 'application/json', },
...
export type PutApiUsersUpdateMembershipLevel23Result = NonNullable<Awaited<ReturnType<typeof putApiUsersUpdateMembershipLevel23>>>
